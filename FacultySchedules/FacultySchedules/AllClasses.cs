...
namespace FacultySchedules
{
	...
	{
		List<string> everyClassName = new List<string>();
		public List<string> getEveryClass()
		{
			...
			try
			{
				...
				connection.Open();
				string stm = "SELECT DISTINCT Name FROM Classes"; //String using query syntax
				...
				while (dataReader.Read())
				{
					...
					{
						everyClassName.Add(dataReader.GetString(i));
					}
				}
			}
